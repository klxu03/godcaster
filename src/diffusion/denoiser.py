...
class DecoderBlock(nn.Module):
    ...
    Parameters:
        ...
        tgt_mask - Target mask, decoder mask 
    """
...
class Transformer(nn.Module):
    def __init__(self, encoder: Encoder, decoder: Decoder, src_embed: InputEmbeddings, src_pos: PositionalEncoding, tgt_pos: PositionalEncoding, projection_layer: ProjectionLayer) -> None:
        super().__init__()
...
def build_transformer(src_vocab_size: int, tgt_vocab_size: int, src_seq_len: int, tgt_seq_len: int, d_model: int = 512, N: int = 6, heads: int = 8, dropout: float = 0.1, d_ff: int = 2048) -> Transformer:
    ...
    pos = PositionalEncoding(d_model, src_seq_len, dropout)
    ...
    # Create transformer
    transformer = Transformer(encoder, decoder, src_embed, tgt_embed, pos, pos, projection_layer)
